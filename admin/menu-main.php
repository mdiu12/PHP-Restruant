...
if(isset($_POST['form1'])) {
	foreach($_POST['arr_order'] as $key=>$value) {
		$statement = $pdo->prepare("UPDATE tbl_menu_main SET menu_order=? WHERE menu_id=?");
...
<section class="content-header">
	<div class="content-header-left">
		<h1>View Menus (Main Menu)</h1>
	</div>
	<div class="content-header-right">
		<a href="menu-main-add.php" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
				...
				<div class="box-body table-responsive">
					...
					<table id="example1" class="table table-bordered table-striped">
						...
						<tbody>
							<?php
							$i=0;
							$statement = $pdo->prepare("SELECT * FROM tbl_menu_main");
							$statement->execute();
