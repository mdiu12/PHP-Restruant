...
if(isset($_POST['form1'])) {
	...
	if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_menu_main (menu_type,menu_name,category_or_page_slug,menu_order,menu_parent,menu_url) VALUES (?,?,?,?,?,?)");
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Add Menu (Main Menu)</h1>
	</div>
	<div class="content-header-right">
		<a href="menu-main.php" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<select class="form-control select2" name="menu_parent" style="width:250px;">
												...
												<?php
												$statement = $pdo->prepare("SELECT * FROM tbl_menu_main ORDER BY menu_order ASC");
												$statement->execute();
												$result = $statement->fetchAll(PDO::FETCH_ASSOC);		
												foreach ($result as $row) {
