						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<select class="form-control select2" name="page_layout" style="width:300px;" onchange="showContentInputArea(this)">
									...
									<option value="Chef Page Layout">Chef Page Layout</option>
									<option value="Menu Style 1 Page Layout">Menu Style 1 Page Layout</option>
									<option value="Menu Style 2 Page Layout">Menu Style 2 Page Layout</option>
									<option value="Menu Style 3 Page Layout">Menu Style 3 Page Layout</option>
									<option value="Menu Style 4 Page Layout">Menu Style 4 Page Layout</option>
									...
									<option value="Reserve Table Page Layout">Reserve Table Page Layout</option>
								</select>
							</div>
						</div>
