...
if(isset($_POST['form1'])) {
    ...
    if($path != '') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' && $ext!='pdf' && $ext!='doc' && $ext!='docx' && $ext!='ppt' && $ext!='pptx' && $ext!='xls' && $ext!='xlsx' && $ext!='zip' && $ext!='rar' && $ext!='JPG' && $ext!='PNG' && $ext!='JPEG' && $ext!='GIF' && $ext!='PDF' && $ext!='DOC' && $ext!='DOCX' && $ext!='PPT' && $ext!='PPTX' && $ext!='XLS' && $ext!='XLSX' && $ext!='ZIP' && $ext!='RAR' ) {
            $valid = 0;
    ...
    if($valid == 1) {
    	...
    	if($path == '') {
    		...
    		unlink('../uploads/'.$_POST['previous_file']);
						...
						<div class="form-group">
				            ...
				            <div class="col-sm-6" style="padding-top:6px;">
		                    	...
		                    	if($fn[1] == 'jpg' || $fn[1] == 'jpeg' || $fn[1] == 'png' || $fn[1] == 'gif') {
		                    		?>
										<img src="../uploads/<?php echo $file_name; ?>" class="existing-photo" style="width:300px;">
		                    		<?php
		                    	} else {
		                    		echo $row['file_name'];
		                    	}
