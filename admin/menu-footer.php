...
<section class="content-header">
	<div class="content-header-left">
		<h1>View Menus (Footer Menu)</h1>
	</div>
	<div class="content-header-right">
		<a href="menu-footer-add.php" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
...
<section class="content">
  	...
  	<div class="row">
    	<div class="col-md-12">
			...
			<p>As you will not change a menu freequently, so we did not make option to edit all items of a menu. You can only change <b>orders.</b> You can create unlimited menus and delete menus when necessary. You can select a category or page as a menu item or can setup another menu with custom link.</p>
