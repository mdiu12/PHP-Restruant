            ...
            <div class="box-body">
                ...
                <div class="form-group">
					...
					<div class="col-sm-2">
						<select class="form-control select2" name="page_layout" style="width:300px;" onchange="showContentInputArea(this)">
							...
							<option value="Chef Page Layout" <?php if($page_layout=='Chef Page Layout') {echo 'selected';} ?>>Chef Page Layout</option>
							<option value="Menu Style 1 Page Layout" <?php if($page_layout=='Menu Style 1 Page Layout') {echo 'selected';} ?>>Menu Style 1 Page Layout</option>
							<option value="Menu Style 2 Page Layout" <?php if($page_layout=='Menu Style 2 Page Layout') {echo 'selected';} ?>>Menu Style 2 Page Layout</option>
							<option value="Menu Style 3 Page Layout" <?php if($page_layout=='Menu Style 3 Page Layout') {echo 'selected';} ?>>Menu Style 3 Page Layout</option>
							<option value="Menu Style 4 Page Layout" <?php if($page_layout=='Menu Style 4 Page Layout') {echo 'selected';} ?>>Menu Style 4 Page Layout</option>
							...
							<option value="Reserve Table Page Layout" <?php if($page_layout=='Reserve Table Page Layout') {echo 'selected';} ?>>Reserve Table Page Layout</option>
						</select>
					</div>
				</div>
                <div class="form-group" id="showPageContent" style="<?php if($page_layout=='News Page Layout' || $page_layout=='About Us Page Layout') {echo 'display:none';}else{echo 'display:block;';} ?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-9" style="padding-top:5px">
						<img src="<?php echo BASE_URL; ?>uploads/<?php echo $banner; ?>" alt="Page Banner" style="width:200px;">
					</div>
				</div>
				<div class="form-group">
