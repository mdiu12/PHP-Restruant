...
<section class="content-header">
	<div class="content-header-left">
		<h1>View Food Menus</h1>
	</div>
	<div class="content-header-right">
		<a href="food-menu-add.php" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td>										
										<a href="food-menu-edit.php?id=<?php echo $row['food_menu_id']; ?>" class="btn btn-primary btn-xs">Edit</a>
										<a href="#" class="btn btn-danger btn-xs" data-href="food-menu-delete.php?id=<?php echo $row['food_menu_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Delete</a>  
									</td>
								</tr>
								<?php
							}
